...
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension(($this->services['security.authorization_checker'] ?? $this->load(__DIR__.'/getSecurity_AuthorizationCheckerService.php'))));
