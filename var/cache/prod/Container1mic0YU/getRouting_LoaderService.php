...
include_once $this->targetDirs[3].'/vendor/olla/api/src/Builder/RouteBuilder.php';
...
$e->addLoader(new \Olla\Api\Builder\RouteBuilder(($this->privates['Olla\Flow\Metadata\Metadata'] ?? $this->load(__DIR__.'/getMetadataService.php'))));
$e->addLoader($d);
