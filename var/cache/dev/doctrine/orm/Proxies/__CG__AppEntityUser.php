...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['title' => NULL, 'content' => NULL, 'events' => NULL];
    ...
    {
        unset($this->title, $this->content, $this->events);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'title', 'content', 'events'];
        }
